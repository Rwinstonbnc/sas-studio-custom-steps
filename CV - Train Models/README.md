...
The step creates an output table that contains reference information needed for the CV - Save Model and CV - Score Images custom steps. The trained model and other important files are stored in the project folder (see "General Setup Details" below for more information).
